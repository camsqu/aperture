    ...
    <div className="font-sans grid grid-rows-[20px_1fr_20px] min-h-screen pt-8 pb-20 gap-16 sm:p-20 bg-cover bg-center bg-no-repeat bg-[url(/wheatley.jpg)]">
      ...
      <div className="sm:flex flex-row gap-5 my-15 justify-center sm:justify-start px-8 sm:px-0">
        ...
        >
          ...
          Block AI Bots / AI Labyrinth
        </a>
      </div>
      <div className="mx-5 sm:mx-0 max-w-3xl text-sm text-gray-300">
        <p>
          The <b>Block AI Bots / AI Labyrinth</b> action demonstrates Cloudflare&apos;s bot
          controls for AI crawlers. Verified AI scrapers can be blocked outright, or sent into
          <b> AI Labyrinth</b> — a maze of AI-generated decoy pages that wastes a scraper&apos;s
          resources. Configure this under <b>Bot Management</b> and <b>AI Crawl Control</b> in the
          dashboard; this button is the trigger surface.
        </p>
      </div>
    </div>
  );
